...
public class WZ_TC_0012 {
	
	@Parameters({ "browserName","userName","password"})
	@Test(priority = 1, description="Modificar Datos Demográficos")
	@Description("Modificar Datos Demográficos")
	static void login(@Optional (Final.CHROME) String browserName, @Optional String userName , @Optional  String pass) throws Exception {
		...
		try {
			...
			*/
			...
			areaPersonal.cambiarDatosDemograficos(codeTC);
